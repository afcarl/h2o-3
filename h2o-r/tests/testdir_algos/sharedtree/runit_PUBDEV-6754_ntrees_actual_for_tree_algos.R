...
test.tree_algos.bernoulli <- function() {
  ...
  Log.info("H2O Isolation Forest with parameters:")  
  ...
  Log.info("H2O Random Forest with parameters:")
  ...
  prostate_xgb <- h2o.xgboost(distribution="auto", ntrees=ntrees_original, seed=1, stopping_metric="auc", stopping_tolerance=0.01, stopping_rounds=5)
