...
public abstract class SharedTree<
  ...
  @Override
  public final Frame getCalibrationFrame() { return _calib; }
...
//      final boolean computeGainsLift = printout;  //only compute Gains/Lift during final scoring
    ...
    PlattScalingHelper.buildCalibrationModel(finalScoring, SharedTree.this, _parms, _job, _model);

    return updated;
  }

  @Override
  public void setCalibrationOutput(GLM calibBuilder, M model) {
