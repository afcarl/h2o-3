...
//  }
  ...
  @Override public ModelMetrics makeModelMetrics(Model m, Frame f, Frame adaptedFrame, Frame preds) {
    ...
    //  ModelMetricsHGLM metricsHGLM = (ModelMetricsHGLM) metrics;
    //  ModelMetricsHGLM metricsHGLM = (ModelMetricsHGLM) metrics; // todo:  put in value from metricsHGLM
      metrics = new ModelMetricsHGLMGaussianGaussian(m, f, metricsBDHGLM._nobs, 0,
              ...
              metricsBDHGLM._bad, metricsBDHGLM._sumEtaDiffSquare, metricsBDHGLM._convergence, metricsBDHGLM._nRandC, 
              metricsBDHGLM._fixf, metricsBDHGLM._ranef, metricsBDHGLM._iterations);
    } else {
      if (_glmf._family == Family.binomial || _glmf._family == Family.quasibinomial) {
